...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="http://cdn.sencha.io/ext-4.1.1-gpl/examples/ux/css/TabScrollerMenu.css"/>
    ...
    <link rel="stylesheet" type="text/css"
          href="http://cdn.sencha.io/ext-4.1.1-gpl/examples/ux/grid/css/GridFilters.css"/>
    <link rel="stylesheet" type="text/css"
          href="http://cdn.sencha.io/ext-4.1.1-gpl/examples/ux/grid/css/RangeMenu.css"/>
    <link href="/assets/css/quran.css" rel="stylesheet" type="text/css"/>
    <script>
    ...
    <script type="text/javascript">
        ...
        var base_url = '/';
        var quran_img = '<?php echo env('QURAN_IMG_MAIN_URL'); ?>';
        var quran_mp3 = '<?php echo env('QURAN_MP3_MAIN_URL'); ?>';
    </script>
</head>

<body>
<div id="loading-mask"></div>
<div id="loading"><span id="loading-message">Sedang Memuat, Mohon Tunggu...</span></div>
<script type="text/javascript">
    document.getElementById('loading-message').innerHTML = '<font face="tahoma" color="white">Memuat Style...</font>';
</script>
<script type="text/javascript">
    document.getElementById('loading-message').innerHTML = '<font face="tahoma" color="white">Memuat System..</font>';
</script>
<script type="text/javascript" src="http://cdn.sencha.io/ext-4.1.1-gpl/ext-all.js"></script>
<script type="text/javascript">
    document.getElementById('loading-message').innerHTML = '<font face="tahoma" color="white">Memuat Aplikasi...</font>';
</script>
<script type="text/javascript">
    document.getElementById('loading-message').innerHTML = '<font face="tahoma" color="white">Inisialisasi...</font>';
</script>
<!-- aplikasi js -->
<script type="text/javascript" src="/assets/js/initVar.js"></script>
<script type="text/javascript" src="/assets/js/funcVar.js"></script>
        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td align="right">
                    ...
                    <script type="text/javascript"
                            src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4f801bfd4ebb5319"></script>
                    <!-- AddThis Button END -->
                </td>
            </tr>
        </table>
