	...
	var menuStore = Ext.create('Ext.data.TreeStore', {
		root: {
			...
			children: [
				...
				{ text: "Menu Lainnya",expanded: true, children: [
						{ text: "Google Apps (*)", leaf: true ,id:'google'},
						...
						{ text: "Al-Qur'an Berdasarkan Topik (*)", leaf: true ,id:'topik'}
					]
				},
				{ text: "Statistik",expanded: true, children: [{ text: "Pengunjung", leaf: true ,id:'pengunjung'}]},
